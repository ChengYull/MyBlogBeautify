(function ($) {
	...
	class Silence {
		...
		buildCopyright() {
            ...
            Theme <a href="https://github.com/Zou-Wang/CNblogs-Theme-Sakura" target="_blank">ChengYu v${this.version}</a></div>`;
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/1873cy/" alt="">' +
					'<ruby><span class="sakuraso"></span><span class="no"></span><span class="shironeko"></span>' +
		...
		mainHeader() {
			...
			var header =
					...
					`       <h1 class="center-text glitch is-glitching Ubuntu-font" data-text="Hi, ChengYu!">${config.title}</h1>` +
		...
		setHomeSuiBiList() {
			...
			for (let i = article_list.length - 1; i >= 0; i--) {
				...
				let bianji = $('.day').find('div.postDesc')[i].firstElementChild.href; //获取编辑链接 https://i.cnblogs.com/EditPosts.aspx?postid=11194299  https://i.cnblogs.com/posts/edit;postId=18757574
				let url
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://www.cnblogs.com/1873cy/"><img src="https://pic.cnblogs.com/face/2734270/20220121143420.png"></a></span><span><a href="https://www.cnblogs.com/1873cy/">风陵南</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
